            ...
            <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="flex items-center">
                ...
                <label htmlFor="privacyPolicy" className="ml-2 block text-sm text-gray-900">
                  I agree to the{' '}
                  <Link href="/privacy-policy" className="text-amber-600 hover:text-amber-500">
                    Privacy Policy
                  </Link>
                </label>
              </div>
            ...
            <div className="mt-6">
              ...
              <div className="mt-6">
                <button
                  ...
                  disabled={isRegistering || isGoogleRegistering}
                  className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 disabled:bg-gray-100 disabled:text-gray-400"
                >
                  {isGoogleRegistering ? (
                    <>
