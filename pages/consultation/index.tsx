...
const ConsultationPage: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Online Legal Consultation | MCS LAW</title>
        <meta name="description" content="Get expert legal advice online through our convenient consultation service." />
          ...
          <div className="mb-12 max-w-3xl mx-auto">
            <div className="relative">
              ...
              <div className="relative flex justify-center">
                <span className="bg-white px-3 text-lg font-medium text-gray-900">How It Works</span>
              </div>
            </div>
            ...
            <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
              <div className="bg-white overflow-hidden shadow rounded-lg">
                <div className="px-4 py-5 sm:p-6 text-center">
                  ...
                  <h3 className="text-lg font-medium text-gray-900">1. Fill the Form</h3>
                  <p className="mt-2 text-sm text-gray-500">
                    Complete the consultation request form with your legal concern details.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white overflow-hidden shadow rounded-lg">
                <div className="px-4 py-5 sm:p-6 text-center">
                  ...
                  <h3 className="text-lg font-medium text-gray-900">2. Get a Quote</h3>
                  <p className="mt-2 text-sm text-gray-500">
                    Receive a fixed-fee quote based on your legal needs within 24 hours.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white overflow-hidden shadow rounded-lg">
                <div className="px-4 py-5 sm:p-6 text-center">
                  ...
                  <h3 className="text-lg font-medium text-gray-900">3. Video Meeting</h3>
                  <p className="mt-2 text-sm text-gray-500">
                    Schedule and attend a video consultation with our legal experts.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white overflow-hidden shadow rounded-lg">
                <div className="px-4 py-5 sm:p-6 text-center">
                  ...
                  <h3 className="text-lg font-medium text-gray-900">4. Legal Solutions</h3>
                  <p className="mt-2 text-sm text-gray-500">
                    Receive personalized legal advice and documentation as needed.
                  </p>
                </div>
              </div>
            </div>
